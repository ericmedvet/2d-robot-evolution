...
package it.units.erallab.robotevo.builder.mapper;
 ...
 */
public class MapperBuilder extends NamedBuilder<Object> {

  private MapperBuilder() {
    register("centralizedVsrBrain", new CentralizedNumGridVSRBrain());
    register("doublesMlp", new DoublesMultiLayerPerceptron());
  }

  private final static MapperBuilder INSTANCE = new MapperBuilder();
